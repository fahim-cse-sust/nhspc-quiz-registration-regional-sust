                  ...
                  {students.map((student) => (
                    <TR key={student.id}>
                      ...
                      <TD className="no-print align-top">
                        <div className="flex min-w-[210px] flex-nowrap justify-end gap-2">
                          {!student.isRegistered ? (
                            <Link href={`/students/new?studentId=${student.id}`} className="inline-flex h-9 shrink-0 items-center justify-center whitespace-nowrap rounded-xl border border-[var(--border)] px-3 text-sm font-semibold hover:bg-[var(--muted)]">
                              Register
                            </Link>
                          ) : (
                            <Link href={`/students/new?studentId=${student.id}`} className="inline-flex h-9 shrink-0 items-center justify-center whitespace-nowrap rounded-xl border border-[var(--border)] px-3 text-sm font-semibold hover:bg-[var(--muted)]">
                          ...
                          <Link href={`/students/${student.id}/edit`} className="inline-flex h-9 shrink-0 items-center justify-center whitespace-nowrap rounded-xl border border-[var(--border)] px-3 text-sm font-semibold hover:bg-[var(--muted)]">
                            Edit
                          </Link>
